...
HD_PWD='/home/tahmed/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab5_b.tcl -notrace
