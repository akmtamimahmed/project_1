...
HD_PWD='/home/tahmed/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5_b.tcl
